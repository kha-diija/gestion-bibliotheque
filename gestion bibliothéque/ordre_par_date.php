...
// Déterminer l'ordre de tri (par défaut : DESC)
...
<div class="container">
    ...
    <div class="sort-bar">
        <form method="get" action="">
            <label for="order">Trier par date d'emprunt :</label>
    ...
    <table id="loanTable">
        ...
        <tbody>
            ...
            if ($result && $result->num_rows > 0) {
                ...
                echo "<tr><td colspan='7' style='text-align: center;'>Aucun emprunt trouvé</td></tr>";
            }
            ?>
        </tbody>
    </table>
