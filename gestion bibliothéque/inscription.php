...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO User (nom, prenom, ville, codePostal, tel, email, type, dateNaissance, inscr, interdit, max_pret, password)
            VALUES ('$nom', '$prenom', '$ville', '$codePostal', '$tel', '$email', '$type', '$dateNaissance', NOW(), 0, 5, '$password')";
