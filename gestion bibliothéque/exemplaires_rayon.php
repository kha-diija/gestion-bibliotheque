...
// Requête pour récupérer tous les exemplaires avec ID qui sont en rayon
$sql = "
SELECT 
...
WHERE e.statut = 'en rayon';  -- Condition pour ne sélectionner que les exemplaires en rayon
";
