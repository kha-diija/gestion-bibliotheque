...
// Requête pour récupérer tous les périodiques triés par titre (ordre croissant)
$sql = "
    SELECT 
        d.id_doc AS ID,
        d.titre AS Titre,
    ...
    <table id="periodiqueTable">
        ...
        <tbody>
            ...
            if ($result && $result->num_rows > 0) {
                ...
                echo "<tr><td colspan='6'>Aucun périodique trouvé</td></tr>"; // Changer le colspan pour correspondre au nombre de colonnes existantes
            }
            ?>
        </tbody>
    </table>
