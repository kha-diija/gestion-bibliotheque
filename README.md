...
<!-- [Capture : page de connexion avec champs email et mot de passe, fond violet] -->

---

### Page d'Inscription — `inscription.php`

<!-- [Capture : formulaire d'inscription avec tous les champs (nom, prénom, date de naissance, ville, code postal, téléphone, email, type, mot de passe)] -->

<!-- [Capture : message d'erreur si champs non remplis ou email déjà utilisé] -->

---

### Réinitialisation du mot de passe — `reset_password.html`

<!-- [Capture : formulaire de changement de mot de passe (ancien + nouveau + confirmation)] -->

---

### Espace Utilisateur — Tableau de bord (`utilisateur.html`)

<!-- [Capture : tableau de bord utilisateur avec menu latéral (Livres, Compte) et zone de contenu principale] -->

---

### Emprunter un Livre (Utilisateur) — `emprunter_livre.php`

<!-- [Capture : liste des livres disponibles avec barre de recherche et bouton Emprunter] -->

---

### Livres Empruntés (Utilisateur) — `livres_empruntes.php`

<!-- [Capture : liste des livres actuellement empruntés par l'utilisateur connecté avec bouton Retourner] -->

---

### Mes Informations (Utilisateur) — `mes_informations.php`

<!-- [Capture : page de profil affichant les informations personnelles de l'utilisateur connecté] -->

---

### Modifier Mon Compte (Utilisateur) — `modifier_compte.php`

<!-- [Capture : formulaire de modification des informations personnelles] -->

---

### Espace Administrateur — Tableau de bord (`admin.php`)

<!-- [Capture : tableau de bord admin avec le frameset 3 panneaux (barre déconnexion, menu latéral complet, zone contenu)] -->

---

### Gestion des Livres (Admin) — `liste_livres.php`

<!-- [Capture : liste complète des livres avec colonnes titre, auteurs, année, éditeur, ISBN, prix] -->

---

### Ajouter un Livre (Admin) — `ajouter_livre.php`

<!-- [Capture : formulaire d'ajout de livre avec champs titre, auteurs, année, éditeur, ISBN, prix] -->

<!-- [Capture : message de succès après ajout d'un livre] -->

---

### Gestion des Périodiques (Admin) — `liste_periodiques.php`

<!-- [Capture : liste des périodiques avec options de tri par titre et par prix] -->

---

### Gestion des Exemplaires (Admin) — `liste_exemplaires.php`

<!-- [Capture : liste des exemplaires avec leur statut (rayon, prêt, maintenance, réserve)] -->

---

### Exemplaires Disponibles — `exemplaires_rayon.php`

<!-- [Capture : vue filtrée des exemplaires disponibles en rayon] -->

---

### Exemplaires en Retard — `exemplaires_retard.php`

<!-- [Capture : vue des exemplaires dont le retour est en retard] -->

---

### Gestion des Emprunts (Admin) — `liste_emprunts.php`

<!-- [Capture : liste complète des emprunts avec utilisateur, exemplaire, dates d'emprunt et de retour] -->

---

### Emprunts du Jour — `aujoudr_emp.php`

<!-- [Capture : liste des emprunts enregistrés aujourd'hui] -->

---

### Documents les Plus Empruntés — `plus_emp.php`

<!-- [Capture : classement des documents les plus empruntés] -->

---

### Gestion des Utilisateurs (Admin) — `liste_utilisateurs.php`

<!-- [Capture : liste complète des utilisateurs avec informations (nom, email, type, statut)] -->

---

### Utilisateurs Bloqués — `util_bloc.php`

<!-- [Capture : liste des utilisateurs dont le compte est bloqué (interdit=1)] -->

---

### Ajouter un Utilisateur (Admin) — `ajout_ut.php`

<!-- [Capture : formulaire admin d'ajout d'utilisateur avec tous les champs et sélection du type] -->

---

### Emprunts d'un Utilisateur (Admin) — `empint_utilisat.php`

<!-- [Capture : liste des emprunts en cours pour un utilisateur sélectionné] -->

---

### Gestion des Amendes (Admin) — `liste_amende.php`

<!-- [Capture : liste des amendes avec utilisateur, exemplaire, montant et raison] -->

---

### Enregistrer une Amende (Admin) — `enreg_amende.php`

<!-- [Capture : formulaire d'enregistrement d'une amende avec sélection utilisateur et exemplaire] -->

---

### Statistiques (Admin) — `stat.php`

<!-- [Capture : page de statistiques affichant le nombre total de documents, exemplaires, livres, périodiques et utilisateurs] -->

---

### Notifications — Emprunts en Retard — `notif.php`

<!-- [Capture : liste des emprunts en retard avec nom utilisateur, document emprunté et date limite dépassée] -->

---

### Envoyer un Message (Admin) — `envoy.php`

<!-- [Capture : interface d'envoi de message aux utilisateurs en retard] -->

---

### Espace Stagiaire — Tableau de bord (`stagiaire.php`)

<!-- [Capture : tableau de bord stagiaire avec accès en lecture seule aux livres, périodiques, emprunts et utilisateurs] -->
